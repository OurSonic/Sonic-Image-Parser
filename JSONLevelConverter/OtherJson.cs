    ...
    public class SLData
    {
        ...
        public static SLData Translate(JSONLevelData data)
        {
            ...
            SLData d2 = new SLData() {
                                             ...
                                             StartPositions =
                                                     new List<SLDataStartPositionEntry>(
                                                     data.StartPositions.Select(a => new SLDataStartPositionEntry() {Type = a.Type, X = a.X, Y = a.Y})),
                                             AnimatedFiles = toTripleByteArray(data.AnimatedFiles),
                                             Animations = new List<SLDataAnimation>(data.Animations.Select(a => new SLDataAnimation() {
                                                                                                                                              AnimationFile
                                                                                                                                                      =
                                                                                                                                                      a
                                                                                                                                                      .
                                             ...
                                             Blocks =
                                                     toDoublAnotherArray(data.Blocks,
                                                                         a =>
                                                                         new SLDataPatternIndex() {
                                                                                                          Palette = a.Palette,
                                                                                                          Priority = a.Priority,
                                                                                                          Tile = a.Tile,
                                                                                                          XFlip = a.XFlip,
                                             ...
                                             Chunks =
                                                     toDoublAnotherArray(data.Chunks,
                                                                         a =>
                                             ...
                                             Objects =
                                                     toAnotherArray(data.Objects,
                                                                    a =>
                                                                    new SLDataObjectEntry() {
                                                                                                    ID = a.ID,
                                                                                                    SubType = a.SubType,
                                                                                                    X = a.X,
                                                                                                    Y = a.Y,
                                             ...
                                             CNZBumpers =
                                                     toAnotherArray(data.CNZBumpers, a => new SLDataCNZBumperEntry() {ID = a.ID, X = a.X, Y = a.Y}),
